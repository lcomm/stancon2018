...
author: "Leah Comment"
date: "9/7/2017 (updated 10/24/2017)"
output:
...
TODO(LCOMM): Decide about prior specification for simple mediator model.
...
f(u_i | \boldsymbol{\gamma}, \mathbf{z}_i, a_i) 
$$
...
f(y_i | \boldsymbol{\alpha}, \mathbf{z}_i, a_i, m_i, u_i) 
f(m_i | \boldsymbol{\beta}, \mathbf{z}_i, a_i, u_i) 
P(U_i = u_i | \boldsymbol{\gamma}, \mathbf{z}_i, a_i) 
$$
...
P(U_i = u | \boldsymbol{\gamma}, \mathbf{z}_i, a_i)
\right]
$$

TODO(LCOMM): decide if I have to go back to other marginalization strategy used for categorical mediator
